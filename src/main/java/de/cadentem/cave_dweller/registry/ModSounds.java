...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> DWELLER_STALK_1 = registerSoundEvent("stalk_1");
    public static final RegistryObject<SoundEvent> DWELLER_STALK_2 = registerSoundEvent("stalk_2");
    public static final RegistryObject<SoundEvent> DWELLER_STALK_3 = registerSoundEvent("stalk_3");
    public static final RegistryObject<SoundEvent> DWELLER_STALK_4 = registerSoundEvent("stalk_4");
    public static final RegistryObject<SoundEvent> DWELLER_STALK_5 = registerSoundEvent("stalk_5");
